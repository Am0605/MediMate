...
export default function Calendar() {
  ...
  const calendarTheme = {
    ...
    textSectionTitleColor: isDark ? '#A0AEC0' : '#4A5568',
    selectedDayBackgroundColor: Colors[colorScheme].tint,
    selectedDayTextColor: isDark ? '#FFFFFF' : '#000000',
    todayTextColor: '#FF3B30',
    dayTextColor: isDark ? '#E0E0E0' : '#2C3E50',
    textDisabledColor: isDark ? '#555555' : '#A9A9A9',
    dotColor: Colors[colorScheme].notification,
